...
('`[LAGController`]',1),
('`[LAGConfig`]',1),
('`[LAGPartnerConfiguration`]',1),
('`[LoginSnapshotTelemetry`] ',1),
('`[LogPool::',1),
('`[ProcessExternalDevOpsLogins`]',1),
('`[ReadExternalDevopsLoginsFabricProperty`]',1),
('`[ReplicaController',1),
...
('HadrRuntimeCallbacks::WaitForAgMasterReady ',1),
...
('SloInfo',1),
('SloManager::',1),
('SloPropertyBagRestrictionsOverride property not found for database ',1),
('SloRgPropertyBag',1),
